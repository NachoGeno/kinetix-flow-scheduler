-- Fix organization isolation in search_appointments_paginated function
-- This function was missing organization filtering which allowed data from other organizations to appear
...
-- Also fix any similar functions that might have the same organization filtering issue
-- Let's ensure all report functions properly filter by organization

-- Fix get_appointment_stats function to include organization filtering
