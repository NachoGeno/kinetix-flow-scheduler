-- Corregir la función search_patients_paginated para respetar la separación de organizaciones
CREATE OR REPLACE FUNCTION public.search_patients_paginated(search_term text DEFAULT NULL::text, page_number integer DEFAULT 1, page_size integer DEFAULT 50)
 RETURNS TABLE(patient_data jsonb, total_count bigint)
 LANGUAGE sql
 SECURITY DEFINER
