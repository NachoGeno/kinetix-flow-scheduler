-- Agregar el rol 'reception' al enum existente
...
-- Crear función para verificar si el usuario puede manejar plus payments
...
CREATE POLICY "Admins and reception can manage plus payments" 
