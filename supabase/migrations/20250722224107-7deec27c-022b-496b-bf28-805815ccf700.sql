-- Función para generar automáticamente el resumen final cuando se completan todas las sesiones
...
-- Crear trigger para ejecutar la función cuando se actualice un appointment
CREATE TRIGGER trigger_auto_generate_final_summary
    AFTER UPDATE ON appointments
    FOR EACH ROW
    EXECUTE FUNCTION auto_generate_final_summary();